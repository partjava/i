...
export default function RegisterPage() {
  ...
  const [form, setForm] = useState({ name: '', email: '', password: '', confirmPassword: '', bio: '', location: '', website: '', github: '' });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/auth/register', {
        ...
        body: JSON.stringify({ name: form.name, email: form.email, password: form.password, bio: form.bio, location: form.location, website: form.website, github: form.github }),
      });
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <textarea value={form.bio}
                ...
                rows={3}
                className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-gray-900 placeholder-gray-400 transition-all resize-none" />
            </div>

            {/* 所在地 */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1.5">所在地</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* 个人网站 */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1.5">个人网站</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
