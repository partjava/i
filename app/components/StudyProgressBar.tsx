    ...
    <div className="fixed bottom-6 right-6 z-30">
      {collapsed ? (
        <button
          ...
          className="bg-[#faf6f0] rounded-full shadow-lg border border-[#d4c8b8] w-11 h-11 flex items-center justify-center hover:shadow-xl transition-shadow"
          title="学习进度"
        >
        ...
        <div className="bg-[#faf6f0] rounded-xl shadow-lg border border-[#d4c8b8] p-4 flex flex-col gap-3 min-w-[200px]">
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-[#6b5a45]">学习进度</span>
            <button onClick={() => setCollapsed(true)} className="text-[#8b7355] hover:text-[#5c4033]">
        ...
        <button
          ...
          className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-all ${
            completed
              ? 'bg-[#4a6741]/15 text-[#4a6741] hover:bg-[#4a6741]/25 border border-[#4a6741]/30'
              : 'bg-[#f5f0e8] text-[#5c4033] hover:bg-[#e8ddd0] hover:text-[#3d2e20] border border-[#d4c8b8]'
          }`}
        >
          {completed ? (
            <svg className="w-5 h-5 text-[#4a6741]" fill="currentColor" viewBox="0 0 20 20">
