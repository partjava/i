...
const sqlCourses = [
  { name: "数据库基础与环境", href: "/study/sql/intro", duration: "30分钟" },
  { name: "基本查询（SELECT）", href: "/study/sql/select", duration: "45分钟" },
  { name: "条件与排序", href: "/study/sql/where-order", duration: "45分钟" },
  { name: "多表查询与连接", href: "/study/sql/join", duration: "60分钟" },
  { name: "数据增删改", href: "/study/sql/crud", duration: "45分钟" },
  { name: "聚合与分组", href: "/study/sql/group", duration: "45分钟" },
  { name: "子查询与视图", href: "/study/sql/subquery-view", duration: "60分钟" },
  { name: "索引与性能优化", href: "/study/sql/index-optimize", duration: "60分钟" },
  { name: "实战练习", href: "/study/sql/projects", duration: "90分钟" }
];

const learningPath = [
  {
    title: "第一阶段：基础入门",
    description: "掌握SQL基础语法和数据库环境",
    items: [
      sqlCourses[0],
      sqlCourses[1],
      sqlCourses[2],
...
const careerPaths = [
  {
    title: "数据库开发工程师",
    description: "数据库设计、开发与优化",
    skills: ["SQL优化", "数据库设计", "性能调优", "数据建模"]
  },
  {
    title: "数据分析师",
    description: "数据查询、分析与可视化",
    skills: ["数据分析", "可视化", "数据挖掘", "报表开发"]
  },
  {
    title: "后端开发工程师",
    description: "Web后端与数据接口开发",
    skills: ["API设计", "ORM", "数据库集成", "性能优化"]
  },
  {
    title: "运维工程师",
    description: "数据库运维与安全管理",
    skills: ["备份恢复", "权限管理", "监控报警", "安全加固"]
  }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-5xl font-bold text-gray-900 mb-6">
            掌握SQL技能
            <span className="block text-3xl text-blue-600 mt-2">从入门到实战</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            SQL是关系型数据库的标准查询语言，广泛应用于数据分析、开发、运维等领域。
            本课程将带你系统学习SQL，助力成为数据高手。
          </p>
          <div className="flex justify-center gap-4 mt-8">
            <Link href="/study/sql/intro">
        ...
        <Card className="mb-12 shadow-md">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">为什么选择SQL？</h2>
        ...
        <Card className="mb-12 shadow-md">
          ...
          <p className="text-gray-600 text-center mb-8">系统掌握SQL技能</p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {sqlCourses.map((course, index) => (
