...
const META: LessonMeta = {
  ...
  prevChapter: { label: '安全部署', href: '/study/security/dev/deploy' },
  nextChapter: { label: '安全项目管理', href: '/study/security/dev/project' },
  theme: THEMES.security,
}

// ============ 代码片段常量 ============

const CODE_SYSTEM_CONFIG = `#!/bin/bash
# system_config.sh
...
const CODE_PATCH_MANAGEMENT = `#!/bin/bash
# patch_management.sh
...
const CODE_ACCOUNT_MANAGEMENT = `#!/bin/bash
...
const CODE_NETWORK_CONFIG = `#!/bin/bash
# network_config.sh
...
const CODE_NETWORK_MONITOR = `#!/bin/bash
# network_monitor.sh
...
const CODE_SECURITY_POLICY = `#!/bin/bash
# security_policy.sh
...
const CODE_SECURITY_ASSESSMENT = `#!/bin/bash
...
const CODE_ALERTMANAGER = `# alertmanager.yml
global:
  resolve_timeout: 5m
...
const CODE_INCIDENT_RESPONSE = `#!/bin/bash
...
const SPREADS = [
  // ===== 跨页 1: 安全运维概述 =====
  {
    ...
    left: (
      <div className="space-y-4">
        ...
        <SectionTitle>1. 安全运维的重要性</SectionTitle>
        <div className="bg-gray-100 p-4 rounded-lg">
          <BookParagraph>
            安全运维是确保信息系统持续安全运行的关键环节，它涵盖了从系统维护、网络管理到安全防护的全方位工作。良好的安全运维可以：
          </BookParagraph>
          <BookList items={[
            '预防安全事件的发生',
            '及时发现和处理安全威胁',
        ...
        <SectionTitle>2. 安全运维的主要内容</SectionTitle>
        <div className="bg-gray-100 p-4 rounded-lg">
    ...
    right: (
      <div className="space-y-4">
        <SectionTitle>3. 安全运维的工作流程</SectionTitle>
        <div className="bg-gray-100 p-4 rounded-lg">
          <ul className="list-disc pl-6 space-y-2">
            <li>日常运维
              <ul className="list-disc pl-6 mt-1 space-y-0.5 text-sm">
  ...
  // ===== 跨页 2: 系统运维 =====
  {
    ...
    left: (
      <div className="space-y-4">
        <PageTitle>系统运维</PageTitle>
        <SectionTitle>1. 系统配置管理</SectionTitle>
        <BookParagraph>配置管理脚本示例：</BookParagraph>
        <BookCode language="bash" maxLines={0} code={CODE_SYSTEM_CONFIG} />
        <BookDivider />
        <SectionTitle>2. 补丁管理</SectionTitle>
        <BookParagraph>补丁管理脚本示例：</BookParagraph>
        <BookCode language="bash" maxLines={0} code={CODE_PATCH_MANAGEMENT} />
      </div>
    ),
    right: (
      <div className="space-y-4">
        <SectionTitle>3. 账号管理</SectionTitle>
        <BookParagraph>账号管理脚本示例：</BookParagraph>
        <BookCode language="bash" maxLines={0} code={CODE_ACCOUNT_MANAGEMENT} />
      </div>
    ),
  },
  ...
  // ===== 跨页 3: 网络运维 =====
  {
    ...
    left: (
      <div className="space-y-4">
        <PageTitle>网络运维</PageTitle>
        <SectionTitle>1. 网络配置管理</SectionTitle>
        <BookParagraph>网络配置脚本示例：</BookParagraph>
        <BookCode language="bash" maxLines={0} code={CODE_NETWORK_CONFIG} />
      </div>
    ),
    right: (
      <div className="space-y-4">
        <SectionTitle>2. 网络监控</SectionTitle>
        <BookParagraph>网络监控脚本示例：</BookParagraph>
        <BookCode language="bash" maxLines={0} code={CODE_NETWORK_MONITOR} />
      </div>
    ),
  },
  ...
  // ===== 跨页 4: 安全管理 =====
  {
    ...
    left: (
      <div className="space-y-4">
        ...
        <SectionTitle>1. 安全策略管理</SectionTitle>
        <BookParagraph>安全策略配置示例：</BookParagraph>
        <BookCode language="bash" maxLines={0} code={CODE_SECURITY_POLICY} />
      </div>
    ),
    right: (
      <div className="space-y-4">
        <SectionTitle>2. 安全评估</SectionTitle>
        <BookParagraph>安全评估脚本示例：</BookParagraph>
        <BookCode language="bash" maxLines={0} code={CODE_SECURITY_ASSESSMENT} />
      </div>
    ),
  },
  ...
  // ===== 跨页 5: 监控告警 =====
  {
    ...
    right: (
      <div className="space-y-4">
        <SectionTitle>3. 告警配置</SectionTitle>
        <BookParagraph>Alertmanager配置示例：</BookParagraph>
        <BookCode language="yaml" maxLines={0} code={CODE_ALERTMANAGER} />
      </div>
    ),
  },
  ...
  // ===== 跨页 6: 应急响应 =====
  {
    ...
    left: (
      <div className="space-y-4">
        <PageTitle>应急响应</PageTitle>
        <SectionTitle>1. 应急响应流程</SectionTitle>
        <div className="bg-gray-100 p-4 rounded-lg">
          <ul className="list-disc pl-6 space-y-2">
            <li>发现与报告
              <ul className="list-disc pl-6 mt-1 space-y-0.5 text-sm">
        ...
        <BookDivider />
        <SectionTitle>2. 应急处置脚本</SectionTitle>
        <BookParagraph>应急处置脚本示例：</BookParagraph>
        <BookCode language="bash" maxLines={0} code={CODE_INCIDENT_RESPONSE} />
      </div>
    ),
    right: (
      <div className="space-y-4">
        <SectionTitle>3. 应急预案</SectionTitle>
        <div className="bg-gray-100 p-4 rounded-lg">
          <ul className="list-disc pl-6 space-y-2">
            <li>DDoS攻击预案
              <ul className="list-disc pl-6 mt-1 space-y-0.5 text-sm">
